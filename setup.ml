...
(* OASIS_START *)
(* DO NOT EDIT (digest: 72f49d8d668bfb729befdf787131f615) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("test_bitarray", []))];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bitarray_bindgen.ml"
                   });
               Library
                 ({
                     cs_name = "bitarray";
                  ...
                  },
                   {
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "bitarray_bindgen"
                        ];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {
                      lib_modules = ["Bitarray"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Bitarray_bindings"; "Bitarray_generated"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "bitarray";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "bitarray"];
                      bs_build_tools =
                   ...
                   {exec_custom = false; exec_main_is = "simple.ml"});
               Flag
                 ({
                     cs_name = "bench";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      flag_description = Some "Bench";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Executable
                 ({
                     cs_name = "bench_obitarray";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "bitarray";
                           FindlibPackage ("core", None);
                           FindlibPackage ("core_bench", None)
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamlbuild"
                        ];
                   ...
                   {exec_custom = false; exec_main_is = "bench_obitarray.ml"});
               Executable
                 ({
                     cs_name = "test_bitarray";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "test_bitarray.ml"});
               Test
                 ({
                     cs_name = "test_bitarray";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\224d\251\186\142=\130#\r\236\206t\"T\177\219";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
